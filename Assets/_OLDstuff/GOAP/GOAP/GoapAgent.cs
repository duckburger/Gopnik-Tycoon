...
public sealed class GoapAgent : MonoBehaviour
{
    ...
    private void createIdleState()
    {
        idleState = (fsm, gameObj) => {
            ...
            else
            {
                ...
                Debug.Log("<color=red>Failed Plan:</color>" + prettyPrint(goal));
    ...
    private void createMoveToState()
    {
        moveToState = (fsm, gameObj) => {
            ...
            {
                Debug.Log("<color=red>Fatal error:</color>" + action.name + " Action requires a target but has none. Planning failed. You did not assign the target in your Action.checkProceduralPrecondition()");
                fsm.popState(); // move
